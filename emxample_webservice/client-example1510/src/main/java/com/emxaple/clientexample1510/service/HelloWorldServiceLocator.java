...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.emxaple.clientexample1510.service.HelloWorldService {
    ...
    public com.emxaple.clientexample1510.service.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.emxaple.clientexample1510.service.HelloWorldPortBindingStub _stub = new com.emxaple.clientexample1510.service.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.emxaple.clientexample1510.service.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.emxaple.clientexample1510.service.HelloWorldPortBindingStub _stub = new com.emxaple.clientexample1510.service.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
